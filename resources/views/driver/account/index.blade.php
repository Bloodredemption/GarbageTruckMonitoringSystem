        ...
        <div class="row justify-content-center my-4">
            <div class="col-md-6 col-sm-8 col-12">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div>
                        <h6 class="card-title">Hi, MENRO Driver</h6>
                        <p style="font-size: 0.9rem;" class="card-text">+639876543210</p>
                    </div>
                </div>

                <div class="list-group fw-semibold">
                    <!-- Menu Item 1 -->
                    ...
                    <a href="#" class="menu-item d-flex align-items-center text-danger"  onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <div class="icon-circle">
