        ...
        <div class="list-group mt-4 gap-3" style="font-size: 0.9rem;">
            <div class="list-group-item border-0 pb-2">
                <div class="col-md-12 position-relative">
                    ...
                    <input type="password" class="form-control rounded custom-border" id="new_password" name="new_password" required>
            ...
            <div class="list-group-item border-0 pb-2">
                <div class="col-md-12 position-relative">
                    ...
                    <input type="password" class="form-control rounded custom-border" id="confirm_password" name="confirm_password" required>
